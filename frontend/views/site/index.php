...
$this->title = Yii::t('app', 'MYTRACKSTORE.COM - only djs, new release, remixes, extended, edits, mashups, partybreaks, exclusive😇');
$this->registerMetaTag([
'name' => 'description',
'content' => Yii::t('app', 'MYTRACKSTORE.COM - only djs, new release, remixes, extended, edits, mashups, partybreaks, exclusive😇'),
]);
$this->registerMetaTag([
'name' => 'keywords',
'content' => 'DJ,Dj,dj,Graff,graff,mytrackstore,store,track,tracks,диджей,крутой диджей, dj graff, лучшие диджеи, новая музыка, лучшая музыка, русская музыка, зарубежная музыка, рэп, шансон, ремикс, remix,rap, диджей на свадьбу,цвет настроения синий, хорошая музыка, best music, швежак, новая волна',
]);
...
$(document).ready(function(){
	...
	setInterval(function(){
		...
		<div id="box-lounch">
			<div class="container pads">
				...
				<div id="awp-playlist-list">
					<div class="searchpanel">
						<input placeholder="<?=Yii::t('app', 'Поиск')?>..." type="text" name="searching" class="searchshit" id="searchshit">
			...
			<div id="awp-wrapper2">
					<p class="toptenheader toptenvid"><?=Yii::t('app', 'ТОП-10 НЕДЕЛИ');?></p>
					<div class="scrollproblems">
						<div class="awp-player-thumb-wrapper">
